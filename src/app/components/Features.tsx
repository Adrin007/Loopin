...
export default function Features() {
  return (
    <section className="relative px-4 md:px-8 font-geist w-full overflow-visible mb-5 mt-7">
      <div className="w-full bg-white rounded-4xl overflow-hidden">
        ...
        <div className="mt-12 md:px-5 grid grid-cols-1 md:grid-cols-2 gap-6">
          <article className="group bg-yellow-300/80 rounded-2xl px-4 py-5 md:p-5 transition-all duration-300">
            <div className="flex flex-row justify-between items-center gap-8 mb-4">
              <div className="flex flex-col flex-1">
                ...
                <h4 className="text-xl text-balance font-semibold text-black mb-2">Need to connect all your <br/> apps—fast?</h4>
            ...
            <button className="w-full mt-5 bg-black hover:opacity-90 transition-all duration-300 text-white text-sm font-medium px-6 py-3 rounded-md flex items-center justify-center gap-2 shadow-md">
          ...
          <article className="group bg-cyan-300/80 rounded-2xl px-4 py-5 md:p-5 transition-all duration-300">
            <div className="flex flex-row justify-between items-center gap-8 mb-4">
              <div className="flex flex-col flex-1">
                ...
                <h4 className="text-xl text-balance font-semibold text-black mb-2">Need your whole team <br/> in sync?</h4>
          ...
          <article className="group bg-blue-300/80 rounded-2xl px-4 py-5 md:p-5 transition-all duration-300">
            <div className="flex flex-row justify-between items-center gap-8 mb-4">
              <div className="flex flex-col flex-1">
                ...
                <p className="text-sm text-black/50 leading-relaxed">Provide competitive benefits packages to your global team with our network of local providers so you can hire full-time talent globally.</p>
              </div>
              <div className="hidden md:block w-35 h-35 flex-shrink-0">
                <Image 
                  src="/f4.avif" 
